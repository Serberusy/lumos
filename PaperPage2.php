...
<body>
	...
	<?php
		...
		$link = mysqli_connect("localhost:3306", "root", "", 'test');  //连接MySQL
...
<?php		
			...
			$a=array();
			$invalid=array("to","for","of","a","an","and","or","in","on","at","under","with","as","based","according","the","measure","mean","means","methods","measures","method","from","avove","about","but","is","am","are","all","but","will","have","has","should","may","might","be");
			if($reference_info){
				echo "<ul>";
